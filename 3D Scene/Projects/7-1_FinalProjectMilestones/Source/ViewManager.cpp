	...
	ShaderManager *pShaderManager)
{
	...
	g_pCamera->Position = glm::vec3(0.0f, 24.0f, 12.0f);
...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	//this callback is used to receive scroll wheel moving event
...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	// move the camera based on mouse movements
...
{
	//adjusts the speed of the movement
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		...
		// change to camera
		g_pCamera->Position = glm::vec3(0.0f, 22.0f, 10.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_P) == GLFW_PRESS)
	{
		...
		// change to camera
		g_pCamera->Position = glm::vec3(0.0f, 20.0f, 8.0f);
		g_pCamera->Front = glm::vec3(0.0f, -0.5f, -2.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
		g_pCamera->Zoom = 80;
	}
